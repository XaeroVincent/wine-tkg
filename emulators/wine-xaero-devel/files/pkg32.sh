...
run_pkg32_old()
{
    ...
    # Show what we're going to do, then do it.
    echo pkg -o ABI="FreeBSD:14:i386" -o OSVERSION=1405000 -o INSTALL_AS_USER=true -o RUN_SCRIPTS=false --rootdir "$I386_ROOT" "$@";
    pkg -o ABI="FreeBSD:14:i386" -o OSVERSION=1405000 -o INSTALL_AS_USER=true -o RUN_SCRIPTS=false --rootdir "$I386_ROOT" "$@";
}
